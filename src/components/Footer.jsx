...
const Footer = () => {
  return (
    <footer>
      <div className="bg-gray-800 py-4 text-gray-400 rounded-xl  -mb-20">
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-[400px]">
              <p className="text-justify">
                "Chúng tôi hiểu rằng hiệu suất mạnh mẽ và trải nghiệm gaming
                tuyệt vời là niềm tự hào của bạn. Vì vậy, ROG Zephyrus G16 luôn
                nỗ lực mang đến những công nghệ tốt nhất để đáp ứng mọi nhu cầu
                của bạn. 'Luôn sẵn sàng chiến đấu, mọi lúc mọi nơi.'"
              </p>
            </div>

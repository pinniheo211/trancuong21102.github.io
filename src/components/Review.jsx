          ...
          >
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
              ...
              <p className=" font-normal text-sm ">
                ...
                mạnh về hiệu năng mà còn rất gọn nhẹ, phù hợp cho những streamer
                di chuyển nhiều như mình. Với cấu hình khủng, mình có thể vừa
                stream vừa chơi game mà không gặp bất kỳ vấn đề gì. Đây chắc
                chắn là lựa chọn hàng đầu cho game thủ."
              </p>
            </div>
          </a>
        </div>
          ...
          >
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
              ...
              <p className=" font-normal text-sm ">
                ...
                chơi game vừa cần làm việc sáng tạo. Mình rất thích hệ thống âm
                thanh Dolby Atmos, nó hỗ trợ tốt cho mình trong việc sản xuất
                nhạc và trải nghiệm gaming cũng rất mượt mà."
              </p>
            </div>
          </a>
        </div>
